...
```gradle
dependencies {
    implementation 'com.github.apiverve:sudoku-api:1.1.12'
}
```
...
```java
import com.apiverve.sudoku.SudokuGeneratorAPIClient;
import com.apiverve.sudoku.APIResponse;
import com.apiverve.sudoku.APIException;

// Initialize the client
SudokuGeneratorAPIClient client = new SudokuGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/sudoku](https://docs.apiverve.com/ref/sudoku)
...
- **Documentation:** [https://docs.apiverve.com/ref/sudoku](https://docs.apiverve.com/ref/sudoku)
- **Issues:** [GitHub Issues](https://github.com/apiverve/sudoku-api/issues)
